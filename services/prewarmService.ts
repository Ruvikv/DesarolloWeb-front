 ...
 * 
 * Desactivado temporalmente para diagnosticar errores de red.
 */
...
//       
//       // Intentar con un endpoint simple primero (GET con CORS para evitar aborts en web)
...
//         
//         // Estrategia: GET con CORS para verificar respuesta real y evitar aborts en web
...
export const prewarmService = {
    startWarmup: () => {},
    warmupBackend: async () => true,
    checkBackendHealth: async () => true,
    getBackendStatus: () => ({ healthy: true, retryCount: 0 }),
};